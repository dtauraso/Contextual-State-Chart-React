    ...
    for (let i = 0; i < bottom.children.length; i++) {
      ...
      if (nextStates.length > 0) {
        ...
        if ("children" in winningState) {
          ...
          // sometimes the winning state isn't getting reset properly
          // getting restarted on the same level
